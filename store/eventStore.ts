...
export const useEventStore = create<EventState>((set, get) => ({
  ...
  setSelectedCategory: (category: EventCategory | null) => set({ selectedCategory: category }),
  setMapBounds: (bounds: MapBounds | null) => set({ mapBounds: bounds }),
  setViewMode: (mode: 'map' | 'list') => set({ viewMode: mode }),
